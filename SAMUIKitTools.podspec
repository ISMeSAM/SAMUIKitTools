Pod::Spec.new do |s|
  ...
  s.source_files    = "SAMUIKitTools","SAMUIKitTools/Categories/Categories.h","SAMUIKitTools/UITOOLs/UITOOLs.h","SAMUIKitTools/Categories/**/*.{h,m}","SAMUIKitTools/UITOOLs/**/*.{h,m,xib}"
